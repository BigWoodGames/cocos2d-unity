...
namespace BBGamelib
{
    public class CC3Charecter : CC3Prefab
    {
        public enum kFrameEventMode{
            LabelFrame,
            EveryFrame,
        }
        public delegate void Callback(CC3Charecter spt);
        float _fpsScale;
        ...
        public CC3Charecter(string path)
        {
            initWithString(path);
        }
        public CC3Charecter(GameObject obj)
        {
            initWithPrefabObj(obj);
        }
        protected CC3Charecter()
        {
        }

        protected override void initWithString(string path)
        {
            base.initWithString(path);
