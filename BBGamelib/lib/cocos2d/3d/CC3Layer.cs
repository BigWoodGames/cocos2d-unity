...
namespace BBGamelib{
	public class CC3LayerBase : CC3Node, CCTouchAllAtOnceDelegate, CCTouchOneByOneDelegate, CCKeyboardEventDelegate, CCMouseEventDelegate
	{
	...
	public class CC3Layer : CC3LayerBase
	{
		bool	_mouseEnabled;
		int		_mousePriority;
