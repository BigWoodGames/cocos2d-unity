...
namespace BBGamelib
{
    public class CCTileSprite : CCNodeRGBA
    {   
        public class Tile{
        ...
        //  init
        // ------------------------------------------------------------------------------
        public CCTileSprite(string textureName) : this(Resources.Load<Texture2D>(textureName))
        {
        }

        public CCTileSprite(Texture2D texture)
        {
